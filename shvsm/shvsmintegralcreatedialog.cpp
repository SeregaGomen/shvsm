...
{
    int index = (age < 12) ? 0 : age - 12;
    float m_s[4][7] = {{ 0.209, 0.209, 0.288, 0.288, 0.317, 0.52 },
                       { 0.209, 0.209, 0.335, 0.335, 0.389, 0.609 },
                       { 0.508, 0.508, 0.570, 0.570, 0.576, 0.787 },
                       { 0.568, 0.568, 0.630, 0.630, 0.632, 0.884 }},
          m[4][7]   = {{ 0.160, 0.160, 0.240, 0.240, 0.264, 0.32 },
                       { 0.169, 0.169, 0.279, 0.279, 0.324, 0.409 },
                       { 0.423, 0.423, 0.475, 0.475, 0.480, 0.587 },
                       { 0.473, 0.473, 0.525, 0.525, 0.552, 0.674 }},
          w_s[4][7] = {{ 0.139, 0.139, 0.179, 0.179, 0.239, 0.42 },
                       { 0.189, 0.189, 0.233, 0.233, 0.239, 0.509 },
                       { 0.469, 0.469, 0.492, 0.492, 0.508, 0.687 },
                       { 0.520, 0.520, 0.552, 0.552, 0.568, 0.774 }},
          w[4][7] =   {{ 0.116, 0.116, 0.149, 0.149, 0.150, 0.26 },
                       { 0.157, 0.157, 0.194, 0.194, 0.199, 0.369 },
                       { 0.391, 0.391, 0.410, 0.410, 0.423, 0.547 },
                       { 0.433, 0.433, 0.460, 0.460, 0.473, 0.634 }},
          (*arr)[7];
...
{
    int index = (age < 12) ? 0 : age - 12;
    float m_s[4][7] = {{ 1800, 1800, 1800, 1700, 1700, 1600, 3200 },
                       { 2199, 2199, 2199, 2099, 2099, 1999, 2801 },
                       { 3000, 3000, 3000, 2900, 2900, 2800, 2000 },
                       { 3400, 3400, 3400, 3300, 3300, 3200, 1600}},
          m[4][7]   = {{ 2200, 2200, 2200, 2100, 2200, 2000, 3600 },
                       { 2599, 2599, 2599, 2499, 2499, 2399, 3201 },
                       { 3400, 3400, 3400, 3300, 3300, 3200, 2400},
                       { 3800, 3800, 3800, 3700, 3700, 3600, 2900 }},
          w_s[4][7] = {{ 2000, 2000, 2000, 1900, 1900, 1800, 3400 },
                       { 2399, 2399, 2399, 2299, 2299, 2199, 3001 },
                       { 3200, 3200, 3200, 3100, 3100, 3000, 2200 },
                       { 3600, 3600, 3600, 3500, 3500, 3400, 1800 }},
          w[4][7] =   {{ 2400, 2400, 2400, 2300, 2300, 2200, 3800 },
                       { 2799, 2799, 2799, 2699, 2699, 2599, 3401 },
                       { 4000, 4000, 4000, 3900, 3900, 3800, 2600 },
                       { 4000, 4000, 4000, 3900, 3900, 3800, 2200 }},
          (*arr)[7];
...
{
    int index = (age < 12) ? 0 : age - 12;
    float m_s[4][7] = {{ 65, 65, 65, 65, 65, 65, 98 },
                       { 71, 74, 74, 75, 75, 75, 93 },
                       { 95, 103, 103, 102, 102, 102, 66 },
                       { 102, 112, 111, 111, 111, 111, 56 }},
          m[4][7]   = {{ 70, 70, 70, 70, 70, 70, 108 },
                       { 76, 79, 79, 80, 80, 80, 103 },
                       { 100, 108, 108, 107, 107, 107, 76 },
                       { 107, 117, 116, 115, 114, 114, 66 }},
          w_s[4][7] = {{ 70, 70, 70, 70, 70, 70, 103 },
                       { 75, 78, 78, 78, 79, 79, 98 },
                       { 99, 107, 107, 106, 106, 106, 66 },
                       { 116, 116, 115, 115, 115, 115, 56 }},
          w[4][7] =   {{ 75, 75, 75, 75, 75, 75, 110 },
                       { 79, 86, 89, 89, 89, 89, 105 },
                       { 109, 109, 109, 104, 104, 104, 78 },
                       { 124, 124, 118, 116, 116, 116, 68 }},
          (*arr)[7];
...
{
    return 100.0*(1.0 - ((fabs(val) - 0.5)/0.5));
}
